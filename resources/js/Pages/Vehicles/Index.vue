                ...
                <div v-for="vehicle in vehicles.data" :key="vehicle.id" class="card overflow-hidden transition hover:shadow-md">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <span class="font-display text-xl font-bold text-gold-600">{{ vehicle.daily_price?.toLocaleString('fr-FR') }} FCFA<span class="text-sm font-normal text-forest-500/50">/jour</span></span>
